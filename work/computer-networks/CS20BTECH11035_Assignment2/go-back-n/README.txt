...
* sudo tc qdisc change dev h1-eth0 root netem loss 0.5%  (execute from xterm h1)
              sudo tc qdisc change dev h2-eth0 root netem loss 0.5%  (execute from xterm h2)

Run receiver code using 
* “python3 CS20BTECH11035_receiverGBN.py” in h2
Run sender code using
* “python3 CS20BTECH11035_senderGBN.py” in h1
